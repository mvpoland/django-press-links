...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'press_links_entry', 'excerpt', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'Entry.excerpt'
        db.alter_column(u'press_links_entry', 'excerpt', self.gf('tinymce.models.HTMLField')())
